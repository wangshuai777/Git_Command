...
//		parentElement.addElement(getInsertBatchBySelectiveElement(introspectedTable, tableName));//批量插入
	...
	public XmlElement getInsertBatchBySelectiveElement(IntrospectedTable introspectedTable,String tableName){
		XmlElement insertBatchElement = new XmlElement("insert");
		insertBatchElement.addAttribute(new Attribute("id", "insertBySelectiveBatch"));
